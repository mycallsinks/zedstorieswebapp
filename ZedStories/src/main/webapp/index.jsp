                ...
                <div class="row d-flex mb-2 ">
                    ...
                    <div class="col-md-8 col-12 main_home_poster card text-bg-dark p-0 poster mb-2 mb-md-0">
                        ...
                        <div class="card-img-overlay post_details p-1">
                            ...
                            <div class="inner_post_details">
                                <h4 class="card-title post_tittle">
                                ...
                                <div class="authors_details d-flex">
                                    <p class="card-text post_author">
                                        <small>Micheal Sinkamba</small>
                                    </p>
                                    <p class="card-text post_date">
                                        <small>24th July 2024</small>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-12 column-container p-0 asides_posters ps-md-1">
                        <div class="aside_normal_poster card text-bg-dark poster">
                            ...
                            <img src="./images/one.jpg" class="card-img img-fluid" alt="..." />
                            <div class="card-img-overlay post_details p-1">
                                <p class="post_category_tittle">Post Category Title</p>
                                <div class="inner_post_details">
                        ...
                        <div class="aside_normal_poster card text-bg-dark poster">
                            ...
                            <img src="./images/two.jpg" class="card-img img-fluid" alt="..." />
                            <div class="card-img-overlay post_details p-1">
                                <p class="post_category_tittle">Post Category Title</p>
                                <div class="inner_post_details">
                                    <h6 class="card-title post_tittle">
                                ...
                                <div class="col-12  card p-0">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-md-5 normal_poster p-0">
                                            <img src="./images/one.jpg" class="img-fluid" alt="...">
                                            <p class="post_category_tittle">Post Category Title</p>
                                        </div>
                                        <div class="col-md-7 m-0">
                                            <div class="card-body post_details ps-1 p-0 pe-1">
                                                <!-- tittle  -->
                                                <h5 class="card-title second_section_post_tittle">Card title Card title
                                                    Card title Card title
                                                    Card title Card title Card title Card title
                                                    Card title Card title Card title Card titlemiche
                                                </h5>
                                                <!-- paragrapgh -->
                                ...
                                <div class="col-12  card p-0">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-md-5 normal_poster p-0">
                                            ...
                                            <img src="./images/two.jpg" class="img-fluid" alt="...">
                                            <p class="post_category_tittle">Post Category Title</p>
                                        </div>
                                        <div class="col-md-7 m-0">
                                            <div class="card-body post_details ps-1 p-0 pe-1">
                    ...
                    <div class="col-12 col-md-4 ">
                        <div class="container-fluid text-center m-0 p-0 borders">
                            <div class="row">
                                ...
                                <div class="col-12  card top_trending p-0 ">
                                    <!-- col-7 -->
                                ...
                                <div class="col-12  card p-0 category_trending ">
                                    <!-- col-8 -->
