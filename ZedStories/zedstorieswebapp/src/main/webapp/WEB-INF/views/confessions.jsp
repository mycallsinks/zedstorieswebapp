                ...
                <div class="row d-flex mb-2 ">
                    ...
                    <div class="col-12 main_home_poster  text-bg-dark p-0 poster mb-2 mb-md-0 orther_pages_landing">
                        <div class=" text-bg-dark  ">
                            ...
                            <img src="./images/confessionLandingpage.jpg" class="card-img img-fluid" alt="...">
                            <div class="card-img-overlay testing ">
                                <h5 class="card-title text-center">Confessions</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-8">
                        <div class="container-fluid text-center m-0 p-0">
                            <div class="row">
                                ...
                                <c:forEach var="post" items="${ConfessionfirstThreeLatest}">
                    ...
                    <div class="col-12 col-md-4 ">
                        <div class="container-fluid text-center m-0 p-0 borders">
                            <div class="row">
                                ...
                                <c:forEach var="post" items="${ConfessionfortherThreeLatest}">
                                        ...
                                        <div class="row g-0 category_trending_posters">
                                            ...
                                            <div class="col-md-7 m-0">
                                                <div class="card-body post_details ps-1 p-0 pe-1">
                                                    <!-- tittle  -->
                                                    <h5 class="card-title second_section_post_tittle">
                                                    <a href="displaypost?id=${post.id}">${post.title}</a></h5>
                                                    <!-- paragrapgh -->
                    ...
                    <div class="col-12 col-md-8">
                        <div class="container-fluid text-center m-0 p-0">
                            <div class="row">
                                ...
                                <!-- second latest posts -->
                                <c:forEach var="post" items="${ConfessionsecondThreeLatest}">
                                    <div class="col-12  card p-0 post">
                                        <!-- col-11 -->
                                        <div class="row g-0">
                                            <div class="col-md-5 normal_poster p-0">
                    ...
                    <div class="col-12 col-md-4 advertisements">
                        <div class="container-fluid text-center m-0 p-0 ps-md-1">
                            <div class="row">
                                ...
                                <div class="col-12  add_poster card p-0 m-0">
<!-- Display single ad -->
<!-- Display single ad -->

<!-- Displaying the confessionAd if available -->
<!-- Displaying the confessionAd if available -->
<c:if test="${not empty confessionsAd}">
    <div class="ad_portion card p-0 m-0">
        <img src="${pageContext.request.contextPath}/${confessionsAd.image}" class="img-fluid" alt="Ad Image">
        <p>${confessionsAd.text}</p>
        <div class="ad_links">
            <a href="${confessionsAd.link1}">${confessionsAd.link1}</a>
            <a href="${confessionsAd.link2}">${confessionsAd.link2}</a>
        </div>
    </div>
</c:if>
