                ...
                <div class="row d-flex mb-2 ">
                    ...
                    <div class="col-12 main_home_poster  text-bg-dark p-0 poster mb-2 mb-md-0 orther_pages_landing">
                        <div class=" text-bg-dark  ">
                            ...
                            <img src="./images/findapartner.jpg" class="card-img img-fluid" alt="...">
                            <div class="card-img-overlay testing ">
                                <h5 class="card-title text-center">Find a Partner</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4 ">
                        <div class="container-fluid text-center m-0 p-0 borders">
                            <div class="row">
                                ...
                                <c:forEach var="post" items="${PartnerfortherThreeLatest}">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="container-fluid text-center m-0 p-0">
                            <div class="row">
                                ...
                                <!-- second latest posts -->
                                <c:forEach var="post" items="${PartnersecondThreeLatest}">
                                    <div class="col-12  card p-0 post">
                                        <!-- col-11 -->
                                        <div class="row g-0">
                                            <div class="col-md-5 normal_poster p-0">
...
<c:if test="${not empty partnerAd}">
    <div class="ad_portion card p-0 m-0">
        <img src="${pageContext.request.contextPath}/${partnerAd.image}" class="img-fluid" alt="Ad Image">
        <p>Text: ${partnerAd.text}</p>
        <div class="ad_links">
            <a href="${partnerAd.link1}">${partnerAd.link1}</a>
            <a href="${partnerAd.link2}">${partnerAd.link2}</a>
        </div>
    </div>
</c:if>
